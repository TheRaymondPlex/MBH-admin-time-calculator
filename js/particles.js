...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:700, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:1, color:"#0cf36c", fill:false}, 
								{id:"medium", num:500, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.3, areaHeight:2, color:"#6ff38c", fill:true}, 
								{id:"large", num:50, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.2, areaHeight:1, color:"#69ec7b", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth:800, ellipseHeight:800, alpha:0.6, offsetX:0, offsetY:0, color:"#0cf36c"}, 
						{ellipseWidth:350, ellipseHeight:550, alpha:0.3, offsetX:-50, offsetY:0, color:"#0cf36c"}, 
						{ellipseWidth:100, ellipseHeight:800, alpha:0.2, offsetX:80, offsetY:-50, color:"#0cf36c"}];
